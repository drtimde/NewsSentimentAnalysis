...
class sentiDictionary:
    ...
    def buildSentiDic(self, positiveFile='positive.txt', negativeFile='negative.txt', levelFile='level_adv.txt',
                      denyFile='deny_adv.txt'):
        ...
        for word_utf8 in positiveWords_utf8:
            positiveWords_unicode.append(word_utf8)
        negativeWords_unicode = []
        for word_utf8 in negativeWords_utf8:
            negativeWords_unicode.append(word_utf8)
        denyWords_unicode = []
        for word_utf8 in denyWords_utf8:
            denyWords_unicode.append(word_utf8)
        levelWords_unicode = []
